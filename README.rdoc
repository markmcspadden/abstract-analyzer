...
Second, in RAILS_ROOT/config/initializers/middlewares.rb
  ...
  # Setup the Analyzer Store & DB
  abstract_analyzer_db = Mongo::Connection.new('localhost', 27017).db('aa-rails-dash-analyzer-db')
  
  # OR
  # abstract_analyzer_db = ActiceRecord::Base.connection
  
  AbstractAnalyzer.store = "mongoDB" # OR "ActiveRecord"
  AbstractAnalyzer.db = abstract_analyzer_db

  # Setup the Analyzer LOGGER
  abstract_logger = Logger.new("#{RAILS_ROOT}/log/abstract_analyzer_logger.log")
  AbstractAnalyzer.logger = abstract_logger
...
Finally, access your stats at /analytics.
